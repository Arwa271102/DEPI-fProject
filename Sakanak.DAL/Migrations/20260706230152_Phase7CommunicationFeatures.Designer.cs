...
namespace Sakanak.DAL.Migrations
{
    ...
    [Migration("20260706230152_Phase7CommunicationFeatures")]
    partial class Phase7CommunicationFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sakanak.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasIndex("RecipientUserId", "IsRead", "SentAt");
            ...
            modelBuilder.Entity("Sakanak.Domain.Entities.Contract", b =>
                {
                    ...
                    b.HasOne("Sakanak.Domain.Entities.Admin", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sakanak.Domain.Entities.Message", b =>
                {
                    b.HasOne("Sakanak.Domain.Entities.ApplicationUser", "RecipientUser")
                        .WithMany()
                        .HasForeignKey("RecipientUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sakanak.Domain.Entities.ApplicationUser", "SenderUser")
                        .WithMany()
